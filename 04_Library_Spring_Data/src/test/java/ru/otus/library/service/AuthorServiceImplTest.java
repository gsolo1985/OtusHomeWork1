...
class AuthorServiceImplTest {
    ...
    public void setUp() {
        ...
        Mockito.when(authorRepository.findById(TOLSTOY_AUTHOR_MOCK_ID)).thenReturn(Optional.ofNullable(tolstoyAuthor));
        Mockito.when(authorRepository.findByName(CHEKHOV_AUTHOR_NAME)).thenReturn(Optional.ofNullable(chekhovAuthor));
