...
insert into usersrole (userid, role)
select (select id from users where login = 'admin') as userid, 'ADMIN' union all
select (select id from users where login = 'user1') as userid, 'USER';