...
CREATE TABLE Document(DocumentID BIGINT IDENTITY PRIMARY KEY, ObjectID BIGINT, OperDate DATE, DebitAccountNumber VARCHAR(20), CreditAccountNumber VARCHAR(20), Amount NUMERIC(28,10), DocComment VARCHAR(255));
